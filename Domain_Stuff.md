...
class Group {
    ...
    static mapping = {
        ...
        groupAssessmentOrders joinTable: [name: "user_group_assessment_order",
...
class UserGroup extends Group {
    ...
    static mapping = {
        ...
        userGroupJoinGroupCompare cascade: "all", joinTable: [name: 'user_group_group_compare',
...
class GroupCompare extends Group {
    ...
    static mapping = {
        ...
        userGroupJoinGroupCompare cascade: "all-delete-orphan",
                                  joinTable: [name: 'group_compare_user_group', column: 'user_group_id', key: 'group_compare_id']
        groupAssessmentOrders cascade: "all-delete-orphan"
    }
...
class GroupCompareJoinUserGroup implements Serializable {
    ...
    static constraints = {
        ...
        userGroup cascade: "none",  validator: {Group val, GroupCompareJoinUserGroup obj, errors ->
